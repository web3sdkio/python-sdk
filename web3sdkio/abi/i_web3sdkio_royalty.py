"""Generated wrapper for IWeb3sdkioRoyalty Solidity contract."""
...
# constructor for IWeb3sdkioRoyalty below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        IWeb3sdkioRoyaltyValidator,
    )
except ImportError:

    class IWeb3sdkioRoyaltyValidator(Validator):  # type: ignore
...
class IWeb3sdkioRoyalty:
    """Wrapper class for IWeb3sdkioRoyalty Solidity contract."""
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: IWeb3sdkioRoyaltyValidator = None,
    ):
        ...
        if not validator:
            validator = IWeb3sdkioRoyaltyValidator(
