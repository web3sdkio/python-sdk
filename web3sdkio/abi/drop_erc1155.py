...
class SetMaxWalletClaimCountMethod(
    ...
    def call(
        self, token_id: int, count: int, tx_params: Optional[TxParams] = None
    ) -> None:
        """Execute underlying contract method via eth_call.
    ...
    def send_transaction(
        ...
        (token_id, count) = self.validate_and_normalize_inputs(token_id, count)
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(token_id, count).transact(
            tx_params.as_dict()
        )
    ...
    def build_transaction(
        ...
        (token_id, count) = self.validate_and_normalize_inputs(token_id, count)
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(token_id, count).buildTransaction(
            tx_params.as_dict()
        )
    ...
    def estimate_gas(
        ...
        (token_id, count) = self.validate_and_normalize_inputs(token_id, count)
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(token_id, count).estimateGas(
            tx_params.as_dict()
        )
...
class SetWalletClaimCountMethod(
    ...
    def validate_and_normalize_inputs(
        self, token_id: int, claimer: str, count: int
    ):
    ...
    def call(
        ...
        :returns: the return value of the underlying method.
        """
        (token_id, claimer, count) = self.validate_and_normalize_inputs(
            token_id, claimer, count
        )
        tx_params = super().normalize_tx_params(tx_params)
        self._underlying_method(token_id, claimer, count).call(
            tx_params.as_dict()
        )
    ...
    def send_transaction(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(token_id, claimer, count).transact(
            tx_params.as_dict()
        )
    ...
    def estimate_gas(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(token_id, claimer, count).estimateGas(
            tx_params.as_dict()
        )
