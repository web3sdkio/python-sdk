"""Generated wrapper for Web3sdkioContract Solidity contract."""
...
# constructor for Web3sdkioContract below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        Web3sdkioContractValidator,
    )
except ImportError:

    class Web3sdkioContractValidator(Validator):  # type: ignore
...
class Web3sdkioContract:
    """Wrapper class for Web3sdkioContract Solidity contract."""
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: Web3sdkioContractValidator = None,
    ):
        ...
        if not validator:
            validator = Web3sdkioContractValidator(
        ...
        self.tw_initialize_owner = TwInitializeOwnerMethod(
            web3_or_provider,
            contract_address,
            functions.tw_initializeOwner,
            validator,
        )
