...
try:
    ...
    class MarketplaceValidator(Validator):  # type: ignore
...
class AcceptOfferMethod(ContractMethod):  # pylint: disable=invalid-name
    ...
    def call(
        ...
        (
            ...
            listing_id, offeror, currency, price_per_token
        )
        tx_params = super().normalize_tx_params(tx_params)
...
class BuyMethod(ContractMethod):  # pylint: disable=invalid-name
    ...
    def call(
        ...
        (
            ...
            listing_id, buy_for, quantity_to_buy, currency, total_price
        )
        tx_params = super().normalize_tx_params(tx_params)
        self._underlying_method(
            listing_id, buy_for, quantity_to_buy, currency, total_price
...
class SetAuctionBuffersMethod(ContractMethod):  # pylint: disable=invalid-name
    ...
    def validate_and_normalize_inputs(
        self, time_buffer: int, bid_buffer_bps: int
    ):
    ...
    def call(
        ...
        :returns: the return value of the underlying method.
        """
        (time_buffer, bid_buffer_bps) = self.validate_and_normalize_inputs(
            time_buffer, bid_buffer_bps
        )
        tx_params = super().normalize_tx_params(tx_params)
        self._underlying_method(time_buffer, bid_buffer_bps).call(
            tx_params.as_dict()
        )
    ...
    def send_transaction(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(time_buffer, bid_buffer_bps).transact(
            tx_params.as_dict()
        )
...
class Web3sdkioFeeMethod(ContractMethod):  # pylint: disable=invalid-name
    """Various interfaces to the web3sdkioFee method."""
...
class Marketplace:
    ...
    web3sdkio_fee: Web3sdkioFeeMethod
    """Constructor-initialized instance of
    :class:`Web3sdkioFeeMethod`.
    """
    ...
    def __init__(
        ...
        self.bid_buffer_bps = BidBufferBpsMethod(
            web3_or_provider, contract_address, functions.bidBufferBps
        )
        ...
        self.offers = OffersMethod(
            web3_or_provider, contract_address, functions.offers, validator
        )
        ...
        self.set_auction_buffers = SetAuctionBuffersMethod(
            web3_or_provider,
            contract_address,
            functions.setAuctionBuffers,
            validator,
        )
        ...
        self.web3sdkio_fee = Web3sdkioFeeMethod(
            web3_or_provider, contract_address, functions.web3sdkioFee
        )

        self.time_buffer = TimeBufferMethod(
            web3_or_provider, contract_address, functions.timeBuffer
        )
        ...
        self.winning_bid = WinningBidMethod(
            web3_or_provider, contract_address, functions.winningBid, validator
        )
