"""Generated wrapper for IWeb3sdkioPrimarySale Solidity contract."""
...
# constructor for IWeb3sdkioPrimarySale below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        IWeb3sdkioPrimarySaleValidator,
    )
except ImportError:

    class IWeb3sdkioPrimarySaleValidator(Validator):  # type: ignore
...
class IWeb3sdkioPrimarySale:
    """Wrapper class for IWeb3sdkioPrimarySale Solidity contract."""
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: IWeb3sdkioPrimarySaleValidator = None,
    ):
        ...
        if not validator:
            validator = IWeb3sdkioPrimarySaleValidator(
