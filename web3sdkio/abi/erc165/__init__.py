...
from web3sdkio_web3 import Web3
from web3sdkio_web3.contract import ContractFunction
from web3sdkio_web3.datastructures import AttributeDict
from web3sdkio_web3.providers.base import BaseProvider
...
try:
    ...
    class ERC165Validator(  # type: ignore
        Validator
    ):
...
class ERC165:
    ...
    def __init__(
        ...
        validator: ERC165Validator = None,
    ):
        ...
        if not validator:
            validator = ERC165Validator(web3_or_provider, contract_address)
