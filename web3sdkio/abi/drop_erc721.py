...
try:
    ...
    class DropERC721Validator(Validator):  # type: ignore
...
class DropERC721:
    ...
    def __init__(
        ...
        functions = self._web3_eth.contract(
            address=to_checksum_address(contract_address), abi=DropERC721.abi()
        ).functions
        ...
        self.base_uri_indices = BaseUriIndicesMethod(
            web3_or_provider,
            contract_address,
            functions.baseURIIndices,
            validator,
        )
