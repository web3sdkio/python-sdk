...
from web3sdk.iomon.sign import EIP712Domain, sign_typed_data_internal
from web3sdkio.constants.events import EventStatus, EventType

from web3sdkio.core.classes.provider_handler import ProviderHandler
from web3.eth import TxReceipt
from eth_account.account import LocalAccount
from zero_ex.contract_wrappers.tx_params import TxParams
from web3sdkio.types.contract import TContractABI
from web3sdkio.types.events import SignatureEvent, TxEvent
...
class ContractWrapper(Generic[TContractABI], ProviderHandler):
    """
    The contract wrapper wraps an instance of a specific web3sdkio contract ABI
    ...
    def __init__(
        ...
        :param contract_abi: ABI of the web3sdkio contract to use
