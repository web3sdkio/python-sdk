...
from web3sdkio.abi.token_erc1155 import ITokenERC1155MintRequest
from web3sdk.iomon.currency import normalize_price_value, set_erc20_allowance
from web3sdk.iomon.nft import upload_or_extract_uris
from web3sdk.iomon.sign import EIP712StandardDomain
from web3sdkio.constants.chains import ChainId
...
from web3sdkio.types.contracts.signature import (
    EIP712DomainType,
    MintRequest1155,
    PayloadToSign1155,
    PayloadWithUri1155,
