...
# from web3sdkio.abi.token_erc1155.bytecode import bytecode as TOKEN_ERC1155_BYTECODE
# from web3sdkio.abi.token_erc20.bytecode import bytecode as TOKEN_ERC20_BYTECODE
# from web3sdkio.abi.token_erc721.bytecode import bytecode as TOKEN_ERC721_BYTECODE
from web3sdkio.types.contract import ContractType
from web3sdkio.contracts import (
    NFTCollection,
    Edition,
    Token,
    Marketplace,
