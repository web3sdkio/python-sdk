...
from web3sdkio.core.classes.erc_721_signature_minting import ERC721SignatureMinting
...
from web3sdkio.types.settings.metadata import NFTCollectionContractMetadata
