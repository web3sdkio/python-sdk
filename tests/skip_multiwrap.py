...
from web3sdkio.contracts import Multiwrap, NFTCollection, Edition, Token
...
from web3sdkio.types.nft import EditionMetadataInput, NFTMetadataInput
...
def multiwrap(sdk: Web3sdkioSDK, primary_account) -> Multiwrap:
...
@pytest.fixture(scope="function")
def nft_collection(sdk: Web3sdkioSDK, multiwrap: Multiwrap) -> NFTCollection:
...
@pytest.mark.usefixtures("sdk", "multiwrap")
@pytest.fixture()
def edition(sdk: Web3sdkioSDK, multiwrap: Multiwrap) -> Edition:
...
@pytest.mark.usefixtures("sdk", "multiwrap")
@pytest.fixture(scope="function")
def token(sdk: Web3sdkioSDK, multiwrap: Multiwrap) -> Token:
    token = sdk.get_token(
