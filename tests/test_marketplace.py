...
from web3sdkio.contracts import Marketplace, NFTCollection, Edition, Token
from brownie import accounts
import pytest
from web3sdkio.types.currency import TokenAmount
from web3sdkio.types.marketplace import NewAuctionListing, NewDirectListing
...
def marketplace(sdk: Web3sdkioSDK, primary_account) -> Marketplace:
...
@pytest.fixture(scope="function")
def nft_collection(sdk: Web3sdkioSDK) -> NFTCollection:
...
@pytest.mark.usefixtures("sdk")
@pytest.fixture()
def edition(sdk: Web3sdkioSDK) -> Edition:
...
@pytest.mark.usefixtures("sdk")
@pytest.fixture(scope="function")
def token(sdk: Web3sdkioSDK) -> Token:
    token = sdk.get_token(
