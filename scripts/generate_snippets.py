...
BASE_DOC_URL = "https://docs.web3sdk.io/python"
...
def generate():
    ...
    for contract in CONTRACTS:
        cls = getattr(web3sdkio.contracts, contract)
        data[contract] = describe(cls)

    cls = web3sdkio.core.auth.WalletAuthenticator
